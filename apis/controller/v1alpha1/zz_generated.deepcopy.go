...
func (in *OverrideConfig) DeepCopyInto(out *OverrideConfig) {
	*out = *in
	if in.RestrictedContainerOverrideFields != nil {
		in, out := &in.RestrictedContainerOverrideFields, &out.RestrictedContainerOverrideFields
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.RestrictedPodOverrideFields != nil {
		in, out := &in.RestrictedPodOverrideFields, &out.RestrictedPodOverrideFields
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
